      ...
      <div>
        ...
        <div className="uchiru_box">
          <div className="uchiru_head card with_progress">
            <a className="back-link" style={{}} href="/teachers/g/61658/subjects/1/course_programs/5/lessons/17090">
